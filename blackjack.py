...
class Blackjack:
    ...
    def draw_card(self):
        ...
        """
        if not self.deck:
            raise RuntimeError("The deck is empty, which should not happen with reshuffling logic. Keep reshuffeling after 5 rounds per deck.")
    ...
    def get_state(self):
        ...
        return (player_value, dealer_card, usable_ace, len(self.player_hand))
